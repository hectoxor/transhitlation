...
{% hint style="info" %}
Чтобы узнать больше о передаточных числах и о том, как они влияют на скорость и крутящий момент, ознакомьтесь с разделом\_[ _Передаточное отношение_ ](broken-reference/)_section_
{% endhint %}
...
{% hint style="info" %}
Один из способов изменить направление вращения в зубчатой передаче - добавить **идлеры**. **Ведомые шестерни** располагаются между входной и выходной шестернями зубчатой передачи и могут помочь вам управлять вращением выходной шестерни. Чтобы узнать больше о ведомых роликах, ознакомьтесь с разделом\_[ _Idler_](broken-reference/) _section_
{% endhint %}
